...
For **autonomous** agents, see [Application synchronization (autonomous agents)](applications-autonomous-mode.md). For documentation covering both modes together, see [Application synchronization](applications.md).
