...
- **argocd-applicationset-controller** (optional, see [ApplicationSets — autonomous agents](../../../user-guide/autonomous-agent/applicationsets-autonomous-mode.md))
...
- ❌ **argocd-applicationset-controller** (not included by default, see [ApplicationSets — managed agents](../../../user-guide/managed-agent/applicationsets-managed-mode.md))
